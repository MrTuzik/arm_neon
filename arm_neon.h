...
__n64 __neon_DdRtRt2(unsigned int _Enc, int64_t);
__n64 __neon_DdRtRt2_acc(unsigned int _Enc, __n64, int64_t);
...
__n128 __neon_QdRtRt2_acc(unsigned int _Enc, __n128, int64);
__n128 __neon_QdRtRt2_dup(unsigned int _Enc, int64);
__n128 __neon_QdRt_acc(unsigned int _Enc, __n128, int);
int64_t __neon_RtRt2Dm(unsigned int _Enc, __n64);
int64_t __neon_RtRt2Qm(unsigned int _Enc, __n128);
